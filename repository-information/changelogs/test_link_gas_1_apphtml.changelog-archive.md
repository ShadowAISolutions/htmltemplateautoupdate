# Changelog Archive — Test Link Gas 1 App

Older version sections rotated from [test_link_gas_1_apphtml.changelog.md](test_link_gas_1_apphtml.changelog.md). Full granularity preserved — entries are moved here verbatim when the main changelog exceeds 50 version sections.

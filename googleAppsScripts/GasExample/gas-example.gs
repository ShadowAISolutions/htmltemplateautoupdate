...
// truth — this file (gas-example.gs) is the ONLY file you need to edit.
//
...
// ── PROJECT CONFIG ────────────────────────────────────────────────
// gas-example.config.json (same directory) is the SINGLE SOURCE OF TRUTH for
...
var VERSION = "01.04g";
var TITLE = "GAS Example";                                      // ← gas-example.config.json

// GitHub config — where to pull code from
var GITHUB_OWNER  = "ShadowAISolutions";
var GITHUB_REPO   = "htmltemplateautoupdate";
var GITHUB_BRANCH = "main";
var FILE_PATH     = "googleAppsScripts/GasExample/gas-example.gs";

// Apps Script deployment ID (from Deploy → Manage deployments)
var DEPLOYMENT_ID = "YOUR_DEPLOYMENT_ID";                        // ← gas-example.config.json

// Google Sheets config (optional — for version tracking)
var SPREADSHEET_ID = "YOUR_SPREADSHEET_ID";                      // ← gas-example.config.json
var SHEET_NAME     = "Live_Sheet";                               // ← gas-example.config.json

// Sound config (optional — Google Drive file ID for notification sound)
var SOUND_FILE_ID = "";                                          // ← gas-example.config.json

// Embedding page URL — the GitHub Pages page that iframes this GAS app
var EMBED_PAGE_URL = "https://ShadowAISolutions.github.io/htmltemplateautoupdate/gas-example.html";

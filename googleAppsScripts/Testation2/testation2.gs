...
// ── PROJECT CONFIG ────────────────────────────────────────────────
// testation2.config.json (same directory) is the SINGLE SOURCE OF TRUTH for
...
var VERSION = "01.02g";
var TITLE = "Tital for testation 2";                                      // ← testation2.config.json
...
var DEPLOYMENT_ID = "AKfycbyTaBYpvIcF64qjZflDwbNBefJ8mooYQ_LYl3Za2rFBdKZ075D8zRsz63sUbcTLGECp";                        // ← testation2.config.json

// Google Sheets config (optional — for version tracking)
var SPREADSHEET_ID = "1nnNzjARD1kqpuaIuFDHrmKgcaaFrPVKl3AMqUTtfLPo";                      // ← testation2.config.json
var SHEET_NAME     = "Live_Sheet";                               // ← testation2.config.json

// Sound config (optional — Google Drive file ID for notification sound)
var SOUND_FILE_ID = "1bzVp6wpTHdJ4BRX8gbtDN73soWpmq1kN";                                          // ← testation2.config.json

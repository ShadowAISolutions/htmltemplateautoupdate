...
// truth — this file (test_link_gas_1_app.gs) is the ONLY file you need to edit.
//
...
// ── PROJECT CONFIG ────────────────────────────────────────────────
// test_link_gas_1_app.config.json (same directory) is the SINGLE SOURCE OF TRUTH for
...
var FILE_PATH     = "googleAppsScripts/TestLinkGas1App/test_link_gas_1_app.gs";

// Apps Script deployment ID (from Deploy → Manage deployments)
var DEPLOYMENT_ID = "AKfycbwGVMBNGN4xtU-pj6d_snNECOUQ_QNDDo5TVNyg9m4mxqOpOnB-fHkzgQCNwbWr4geaEA"; // ← test_link_gas_1_app.config.json

// Google Sheets config (optional — for version tracking)
var SPREADSHEET_ID = "12OgP5hFV34oprTcAShaqlWHN35KZHzD13YjX8H7QhbE"; // ← test_link_gas_1_app.config.json
var SHEET_NAME     = "Live_Sheet";                               // ← test_link_gas_1_app.config.json

// Sound config (optional — Google Drive file ID for notification sound)
var SOUND_FILE_ID = "1bzVp6wpTHdJ4BRX8gbtDN73soWpmq1kN";        // ← test_link_gas_1_app.config.json

// Embedding page URL — the GitHub Pages page that iframes this GAS app
var EMBED_PAGE_URL = "https://ShadowAISolutions.github.io/htmltemplateautoupdate/test_link_gas_1_app.html";

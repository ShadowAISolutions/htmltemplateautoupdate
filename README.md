...
Last updated: `2026-02-18 09:21:16 AM EST`
...
2. Click the **⧉** button (top-right of the code block) to copy the URL, then paste it into the **source repository URL** field:

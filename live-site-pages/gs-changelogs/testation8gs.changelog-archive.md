# Changelog Archive — test 8 (Google Apps Script)

Older version sections rotated from [testation8gs.changelog.md](testation8gs.changelog.md). Full granularity preserved — entries are moved here verbatim when the main changelog exceeds 50 version sections.

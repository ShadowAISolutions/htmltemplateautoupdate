...
>
> Items that **still run normally**: #0, #1, #2, #3, #4, #6, #8, #10, #12, #13, #14, #15, #18. Per-page (#2) and per-GAS (#1) version bumps are safe because they're scoped to the specific file being edited — different sessions working on different pages won't conflict.
>

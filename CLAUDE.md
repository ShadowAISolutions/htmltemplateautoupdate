...
```
For pages that live directly in `live-site-pages/` (not in a subdirectory), the version file, changelog files, and `sounds/` folder sit alongside the HTML file (e.g. `live-site-pages/index.html` + `live-site-pages/indexhtml.version.txt` + `live-site-pages/indexhtml.changelog.md`).

...
- **Live URLs**: immediately before `✅✅CODING COMPLETE✅✅` (after ACTUAL TOTAL COMPLETION TIME), output `🔗🔗LIVE URLS (label)🔗🔗` followed by all live-site links. **Always present when the response ends with CODING COMPLETE** — never skipped for those responses, regardless of what was edited. **Skipped when the response ends with RESEARCH COMPLETE or AWAITING USER RESPONSE.** This gives the user one-click access to the live site on every coding response. Rules:
  ...
  - **Highlight affected pages**: when a page (or its associated `.gs` file) was directly changed in this response, **bold** its label AND append `← ✏️ EDITED` after the URL — e.g. `**Homepage:** [index.html](...) → https://ORG.github.io/REPO/ ← ✏️ EDITED` or `**My Project | Homepage:** [my-project/index.html](...) → https://ORG.github.io/REPO/my-project/ ← ✏️ EDITED`. Pages not affected by the response keep their label unbolded and have no indicator. The bold + `✏️ EDITED` combination provides two levels of visibility — the bold is subtle for scanning, the emoji tag is unmissable
  ...
  - **Format**: one URL per line. When affected: `**Homepage:** [index.html](https://github.com/.../blob/main/live-site-pages/index.html) → https://ShadowAISolutions.github.io/htmltemplateautoupdate/ ← ✏️ EDITED`. When not affected: `Homepage: [index.html](https://github.com/.../blob/main/live-site-pages/index.html) → ...` (no bold, no indicator). For subpages when affected: `**My Project | Homepage:** [my-project/index.html](https://github.com/.../blob/main/live-site-pages/my-project/index.html) → https://ORG.github.io/REPO/my-project/ ← ✏️ EDITED`
...
🔗🔗LIVE URLS (First interaction · Edited HTML)🔗🔗
  ...
  **Homepage:** [index.html](https://github.com/ShadowAISolutions/htmltemplateautoupdate/blob/main/live-site-pages/index.html) → (template repo — no live site deployed) ← ✏️ EDITED
